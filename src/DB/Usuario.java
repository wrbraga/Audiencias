...
public class Usuario  implements java.io.Serializable {
    ...
    public Usuario(int idprocurador, String nome, String sigla, Integer antiguidade, String area, Integer ultimo, int atuando) {
    ...
    public Usuario(int idprocurador, String nome, String sigla, Integer antiguidade, String area) {
       this.idprocurador = idprocurador;
       this.nome = nome;
       this.sigla = sigla;
       this.antiguidade = antiguidade;
